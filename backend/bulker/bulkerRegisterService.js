...
import Service from '../models/serviceModel.js'; // Asegúrate de que la ruta es correcta
import connectDB from './database.js'; // Importar la función de conexión a MongoDB
import Specialty from '../models/specialtyModel.js'; // Asegúrate de que la ruta es correcta
